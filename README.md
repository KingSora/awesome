...
- [esbuild-resolve](https://github.com/KingSora/rollup-plugin-esbuild-resolve) - Use the resolution algorithm implementation of [esbuild](https://github.com/evanw/esbuild).
